...
//    [NSThread sleepForTimeInterval:2];
    ...
    TestVC *test = [TestVC new];
    JPNavigationController *nav_test = [[JPNavigationController alloc]initWithRootViewController:test];
//    UINavigationController *nav_test = [[UINavigationController alloc]initWithRootViewController:test];

    nav_test.tabBarItem.image = [UIImage imageNamed:@"more"];
    nav_test.tabBarItem.selectedImage = [[UIImage imageNamed:@"more_se"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    nav_test.tabBarItem.imageInsets = UIEdgeInsetsMake(7, 0, -7, 0);
    
    
    
    UITabBarController *tabbarVc = [UITabBarController new];
    tabbarVc.viewControllers = @[nav_home, nav_more,nav_test];
